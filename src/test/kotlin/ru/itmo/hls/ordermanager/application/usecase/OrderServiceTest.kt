...
import ru.itmo.hls.ordermanager.infrastructure.db.OrderJpaRepository
import ru.itmo.hls.ordermanager.infrastructure.db.TicketJpaRepository
...
open class OrderServiceIntegrationTest : AbstractIntegrationTest() {
    ...
    @Autowired
    private lateinit var ticketRepository: TicketJpaRepository
    ...
    fun getTicketsPageEmpty() {
        ...
        verifyNoInteractions(seatClient)
    }
